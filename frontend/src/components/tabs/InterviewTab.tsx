...
import { getInterviewGrading, getInterviewQuestions } from "@/services/contentGenerationService";
	...
	return (
		<div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-8 mx-auto w-2/3">
			<div className="flex items-center justify-between gap-2 mb-6">
				<h2 className="text-2xl font-semibold text-gray-800 dark:text-white">Interview Preparation</h2>
				<button
					onClick={handleReset}
			...
			{isLoading ? (
				<div className="flex items-center justify-center py-12">
					...
					<span className="ml-4 text-gray-600 dark:text-gray-300">Generating interview questions...</span>
				</div>
			) : currentInterview ? (
				<div className="space-y-6">
									...
									{aiGradings.has(question.id) && (
										<div className="space-y-4 bg-white dark:bg-gray-800 p-6 rounded-lg border-2 border-purple-300 dark:border-purple-700">
												...
												<div>
													...
													<p
														className={`text-4xl font-bold ${getScoreColor(
															aiGradings.get(question.id)!.score
														)}`}
													>
											...
											<div>
												...
												<div className="text-gray-700 dark:text-gray-300 ml-6">
													<MarkdownRenderer
														content={aiGradings.get(question.id)!.strengths}
													/>
												</div>
											</div>
											...
											<div>
												...
												<div className="text-gray-700 dark:text-gray-300 ml-6">
													<MarkdownRenderer
														content={aiGradings.get(question.id)!.suggestions}
													/>
												</div>
											</div>
					...
					{selfGrades.size > 0 && (
						<div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
							<h3 className="font-semibold text-gray-800 dark:text-white mb-3">Self-Grading Progress</h3>
				...
				<div className="text-center py-12 gap-4 flex flex-col items-center justify-center">
					<p className="text-gray-500 dark:text-gray-400">No interview questions available.</p>
					<button
