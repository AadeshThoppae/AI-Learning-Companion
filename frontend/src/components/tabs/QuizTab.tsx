        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-8 mx-auto w-2/3 ">
            ...
            {isLoading ? (
                ...
                <div>
                    ...
                    {/* Current Quiz */}
                    <Quiz quiz={currentQuizzes[currentIndex]} onAnswer={handleAnswer} isAnswered={answeredQuestions.has(currentIndex)} />
                    {/* Navigation Buttons */}
                ...
                <div className="w-full text-center py-12 gap-4 flex flex-col items-center justify-center">
                    <p className="text-gray-500 dark:text-gray-400">
                        You&apos;ve completed the quiz! Your final score is {score} out of {currentQuizzes.length}. Great job! 🎉
                    </p>
